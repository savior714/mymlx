...
- **MCP-First File Access**: `AGENTS.md`, `PROJECT_RULES.md` 등 **프로젝트 핵심 규칙 파일** 접근 시, **반드시 `mcp--filesystem--read_text_file` 도구를 우선 사용**. `read_file` 도구는 **사용 금지**. (이유: 도구 매핑 일관성 확보 및 MCP 서버 통합)
